 ...
 * @author Tomas Mrazek
 */
public final class BASEContractTenderParser extends BaseDigiwhistTenderParser {
    ...
    public List<ParsedTender> parse(final RawData raw) {
        ...
        final ParsedTender tender = new ParsedTender()
            ...
            .setNationalProcedureType(BASETenderParserUtils.getFirstValueByLabel(contractTable, "Tipo de procedimento"))
            ...
            .setFinalPrice(BASETenderParserUtils.parsePrice(
