 ...
 */
public abstract class BaseDigiwhistTenderMaster extends BaseTenderMaster<MatchedTender, MasterTender> {
    @Override
    ...
    protected final void registerProjectSpecificPlugins() {
        pluginRegistry
                .registerPlugin("MOD+LNN", new ModusPlugin<>(Arrays.asList("buyerAssignedId", "title", "titleEnglish",
                ...
                .registerPlugin("Prices", new GeneralPricePlugin<>(Arrays.asList("documentsPrice", "estimatedPrice",
                        "finalPrice")))
                .registerPlugin("Lots", new DigiwhistTenderLotPlugin())
                ...
                .registerPlugin("Documents", new DigiwhistDocumentPlugin());
