...
/**
 * Digiwhist bid mastering plugin. Matches bids of matched tender lots and creates master record for each bid.
 */
public final class DigiwhistBidPlugin extends BaseBidPlugin<MatchedTenderLot, MasterTenderLot, MatchedBid, MasterBid,
        MatchedTender> {
