 ...
 * @author Marek Mikes
 */
public final class PCETenderCrawler extends BaseDigiwhistIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        ...
        @SuppressWarnings("unchecked") final List<HtmlTableRow> tenderTableRows = (List<HtmlTableRow>) actualPage
                .getByXPath(
                        "//table[@id='myTablaBusquedaCustom']/tbody/tr");
