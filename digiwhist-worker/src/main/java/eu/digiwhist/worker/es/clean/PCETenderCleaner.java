package eu.digiwhist.worker.es.clean;
 ...
 */
public class PCETenderCleaner extends BaseDigiwhistTenderCleaner {
    ...
    private Map<Enum, List<String>> countryMapping() {
        ...
        mapping.put(CountryCode.ES, Arrays.asList("España", "ESPAÑA (PENI. BAL. Y CANARIAS)"));
