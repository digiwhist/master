 ...
 * @author Michal Riha
 */
abstract class BaseETendersTenderCrawler extends BaseDigiwhistIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        ...
        @SuppressWarnings("unchecked") final List<HtmlTableRow> htmlTableBody = (List<HtmlTableRow>) page.getByXPath(
                "//table[@class='table table-striped table-bordered sorter']/tbody/tr");
        ...
        for (HtmlTableRow htmlTableRow : htmlTableBody) {
            ...
            try {
                ...
                @SuppressWarnings("unchecked") List<HtmlAnchor> documentsOnDetailPage = (List<HtmlAnchor>) detailPage
                        .getByXPath("//span[text()='Date of publishing']/../../../tr/td/a[@target='_blank']");
