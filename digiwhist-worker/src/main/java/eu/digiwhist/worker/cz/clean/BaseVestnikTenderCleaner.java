...
import eu.digiwhist.worker.cz.clean.plugin.VestnikLotPlugin;
import eu.digiwhist.worker.cz.clean.plugin.VestnikNpwpReasonPlugin;
import eu.digiwhist.worker.cz.clean.plugin.VestnikSelectionMethodPlugin;
import eu.digiwhist.worker.cz.clean.plugin.VestnikTenderProcedureTypePlugin;
 ...
 * @author Kuba Krafka
 */
public abstract class BaseVestnikTenderCleaner extends BaseDigiwhistTenderCleaner {
