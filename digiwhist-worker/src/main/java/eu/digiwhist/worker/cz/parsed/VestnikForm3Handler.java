...
/**
 * Handler for parsing form 3 - Contract award notice.
 */
public final class VestnikForm3Handler extends VestnikContractAwardHandler {

    /**
     * Suppress default constructor for noninstantiability.
     */
    private VestnikForm3Handler() {
    ...
    private static String parseBuyerType(final Document form) {
        ...
        if (buyerType != null && buyerType.equalsIgnoreCase("OTHER")) {
            return VestnikTenderParserUtils.getFieldValue(subsectionI2, "FormItems\\.ProsimUpresnete_I_2");
        } else {
            return buyerType;
        }
    }
    ...
    private static List<String> parseMainActivities(final Document form) {
        ...
        if (VestnikTenderParserUtils.isInputFieldChecked(subsectionI3, "FormItems\\.JinyProsimSpecifikujte_I_3")) {
            activities.add(
                    VestnikTenderParserUtils.getFieldValue(subsectionI3, "FormItems\\.JinyProsimSpecifikujteB_I_3"));
        }
        return activities;
    }
}
