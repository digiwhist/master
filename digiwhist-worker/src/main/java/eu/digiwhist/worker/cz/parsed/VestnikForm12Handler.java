...
/**
 * Handler for parsing form 12 - Design contest notice.
 */
public final class VestnikForm12Handler extends VestnikContractNoticeHandler {

    /**
     * Suppress default constructor for noninstantiability.
     */
    private VestnikForm12Handler() {
    ...
    private static List<String> parseMainActivities(final Document form) {
        ...
        if (VestnikTenderParserUtils.isInputFieldChecked(subsectionI3, "FormItems\\.HpcJiny_I_3")) {
            activities.add(VestnikTenderParserUtils.getFieldValue(subsectionI3, "FormItems\\.HpcUpresneni_I_3"));
        }
