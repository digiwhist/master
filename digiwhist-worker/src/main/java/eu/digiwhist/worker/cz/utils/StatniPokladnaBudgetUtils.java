package eu.digiwhist.worker.cz.utils;

import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINM201Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINM202Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINM207Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINU101Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINU102Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINU104Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINU105Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINU106Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINU107Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaFINU108Handler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaHandler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaMISRISHandler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaMISRISZUHandler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaROZVHandler;
import eu.digiwhist.worker.cz.parsed.StatniPokladnaVYKZZHandler;
...
public final class StatniPokladnaBudgetUtils {
    ...
    public static String getDatasetIdentificator(final String fileName) {
        Matcher m = Pattern.compile("(FINM20[1-357]|FINU10[124-8]|ROZV|VYKZZ|MIS\\-RIS(\\-ZU)?).*")
            .matcher(fileName);
