package eu.digiwhist.worker.hu.raw;
 ...
 * @author Michal Riha
 */
public final class KHTenderCrawler extends BaseDigiwhistIncrementalPagedSourceHttpCrawler {
...
//        getWebClient().getOptions().setJavaScriptEnabled(true);
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        @SuppressWarnings("unchecked") final List<HtmlAnchor> nodes = (List<HtmlAnchor>) page.getByXPath(
                "//table[@class='results results__hirdetmeny results_with-link']//tr/td[1]/a");
