package eu.digiwhist.worker.nl.matched;
...
/**
 * Tender matcher for TenderNed in Netherlands.
 *
 * @author Marek Mikes
 */
public class TenderNedTenderMatcher extends BaseDigiwhistTenderMatcher {
