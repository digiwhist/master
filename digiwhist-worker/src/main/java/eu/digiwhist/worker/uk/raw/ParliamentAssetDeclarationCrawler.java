...
public final class ParliamentAssetDeclarationCrawler extends BaseHttpCrawler {
    ...
    protected void doWork(final Message message) {
        try {
            ...
            final List<HtmlAnchor> yearLinks = (List<HtmlAnchor>) firstPage.getByXPath(
            ...
            for (HtmlAnchor yearLink : yearLinks) {
                ...
                final List<HtmlAnchor> dayLinks = (List<HtmlAnchor>) yearPage.getByXPath(
                ...
                for (HtmlAnchor dayLink : dayLinks) {
                    ...
                    final List<HtmlAnchor> memberDetailPageLinks = (List<HtmlAnchor>) listOfMembersInOneDayPage
                            .getByXPath(
