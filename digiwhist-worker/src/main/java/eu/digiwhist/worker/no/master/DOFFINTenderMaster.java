package eu.digiwhist.worker.no.master;
...
/**
 * Tender master for Doffin in Norway.
 *
 * @author Marek Mikes
 */
public class DOFFINTenderMaster extends BaseDigiwhistTenderMaster {
    ...
    protected final Currency getNationalCurrency() {
        return Currency.getInstance("NOK");
    }
