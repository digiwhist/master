package eu.digiwhist.worker.ee.clean;
 ...
 * @author Marek Mikes
 */
public final class EPETenderCleaner extends BaseDigiwhistTenderCleaner {
    ...
    private static Map<Enum, List<String>> procedureTypeMapping() {
        ...
        mapping.put(TenderProcedureType.DESIGN_CONTEST, Arrays.asList("Avatud ideekonkurss",
            "Piiratud osalejate arvuga ideekonkurss"));
        ...
        mapping.put(TenderProcedureType.OTHER, Arrays.asList("Lihtsustatud korras teenuste tellimine", "Erand § 14",
            "Vabatahtlik teade"));
        mapping.put(TenderProcedureType.OUTRIGHT_AWARD, Arrays.asList("Vabatahtlik teade - leping ilma hanketeate"
            + " eelneva avaldamis"));
