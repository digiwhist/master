 ...
 * @author Tomas Mrazek
 */
public final class SPATenderCrawler extends BaseDigiwhistIncrementalCrawler {
    ...
    private String getTenderPermalink(final Document page) {
        String permalink = JsoupUtils.selectText("#app_main pre:contains(Tender Link::)", page);
        return (permalink == null ? null : permalink.replace("Tender Link::", "").trim());
    }
