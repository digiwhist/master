package eu.digiwhist.worker.hr.master;
...
/**
 * Tender master for Croatia.
 *
 * @author Marek Mikes
 */
public class EOJNTenderMaster extends BaseDigiwhistTenderMaster {
    ...
    protected final Currency getNationalCurrency() {
        return Currency.getInstance("HRK");
    }
}
