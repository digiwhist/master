 ...
 * @author Tomas Mrazek
 */
public final class EOJNTenderCrawler extends BaseDigiwhistIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        final List<HtmlAnchor> detailAnchors = (List<HtmlAnchor>) page.getByXPath(
                "//tr[contains(@id, 'uiView_gridResults_Row_')]/td[1]/a");
