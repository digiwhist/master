 ...
 *   set createdBy = 'eu.digiwhist.worker.fr.raw.BOAMPTenderDownloader',
 *   modifiedby = 'eu.digiwhist.worker.fr.raw.BOAMPTenderDownloader'
 *   where modifiedby = 'eu.digiwhist.worker.fr.BOAMPFtpAndHtmlMergeWorker';
 *
 * @author Marek Mikes
 */
public final class BOAMPFtpAndHtmlMergeWorker extends BaseWorker {
    ...
    public void doWork(final Message message) {
        ...
        List<String> ftpRawIds = rawDAO.getIdsBySourceAndVersion("eu.digiwhist.worker.fr.raw.BOAMPFtpTenderDownloader",
                "3");
    ...
    private void mergeAndSave(final String sourceData, final URL sourceUrl, final String sourceFileName,
        ...
        final Raw webRecord = rawDAO.getBySourceUrl("eu.digiwhist.worker.fr.raw.BOAMPWebTenderDownloader", "1",
                webPublicationUrl);
