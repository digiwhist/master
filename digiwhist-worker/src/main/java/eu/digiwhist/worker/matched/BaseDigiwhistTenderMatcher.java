package eu.digiwhist.worker.matched;
...
/**
 * Digiwhist base tender matcher providing correct DAO implementations.
 */
public abstract class BaseDigiwhistTenderMatcher extends BaseTenderMatcher {
     ...
     */
    protected BaseDigiwhistTenderMatcher(final List<Pair<String, String>> additionalMatchers) {
     ...
     * Default constructor.
     */
    protected BaseDigiwhistTenderMatcher() {
        super();
    }
