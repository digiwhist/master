...
public final class CIAPublicOfficialCrawler extends BaseHttpCrawler {
    ...
    protected void doWork(final Message message) {
        try {
            ...
            @SuppressWarnings("unchecked") final List<HtmlAnchor> linksToCountryDetail = (List<HtmlAnchor>) page
                    .getByXPath(
                            "//ul[@id='cosCountryList']/li/a");
            ...
            for (HtmlAnchor linkToDetail : linksToCountryDetail) {
                ...
                if (EuCountry.contains(linkToDetail.getTextContent())) {
                    ...
                    @SuppressWarnings("unchecked") final List<HtmlAnchor> linksToPdf = (List<HtmlAnchor>) page
                            .getByXPath(
                                    "//div[@class='demo']/div/div/ul/li/a[starts-with(@href, 'pdfs')]");
