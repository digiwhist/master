...
/**
 * Test of Digiwhist tender lot matching and mastering.
 *
 * @author Marek Mikes
 */
public final class DigiwhistTenderLotPluginTest {
     ...
     */
    public DigiwhistTenderLotPluginTest() {
    ...
    public void masterLotCountTest() {
        final BaseTenderLotPlugin lotPlugin = new DigiwhistTenderLotPlugin();
