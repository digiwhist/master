...
/**
 * Test of Digiwhist bid matching and mastering.
 *
 * @author Marek Mikes
 */
public final class DigiwhistBidPluginTest {
    ...
    public void masterBidCountTest() {
        ...
        final BaseBidPlugin bidPlugin = new DigiwhistBidPlugin();
