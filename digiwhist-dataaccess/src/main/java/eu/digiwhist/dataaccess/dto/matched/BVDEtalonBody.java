package eu.digiwhist.dataaccess.dto.matched;
 ...
 */
@Entity
@Table(schema = "bvd", name = "registry_information")
public class BVDEtalonBody implements EtalonBody {    
     ...
     */
    @Column(name="street_no_building_etc_line_1")
     ...
     */
    @Column(name="european_vat_number")
     ...
     */
    @Column(name="statistical_number")
