package eu.datlab.worker.si.clean;
 ...
 * @author Marek Mikes
 */
public class ENarocanjeTenderCleaner extends BaseDatlabTenderCleaner {
    ...
    protected final CleanTender postProcessSourceSpecificRules(final ParsedTender parsedTender,
        ...
        cleanTender.getPublications()
            .stream()
            .filter(p -> p != null && !Boolean.TRUE.equals(p.getIsIncluded()) && p.getSourceFormType() != null
                && p.getSourceFormType().contains("preklic/popravek"))
    ...
    protected final void registerSpecificPlugins() {
        pluginRegistry
            ...
            .registerPlugin("publications", new PublicationPlugin(NUMBER_FORMAT, DATE_FORMATTERS, getFormTypeMapping()))
