 ...
 * @author Marek Mikes
 */
public class HungaryOldDataTenderParser extends BaseDatlabTenderParser {
     ...
     *
     * @param record CSV record to be parsed
     ...
     * @param prefix price columns names prefix
     * @return ParsedPrice
     */
    private static ParsedPrice parsePrice(final CSVRecord record, final String prefix) {
        ...
        if (isEnabled(record.get(prefix + "afa_fv")) && !prefix.equals("eh_k_s_")) {
            price
     ...
     *
     * @param record CSV record
     * @param prefix body columns names prefix
     * @return ParsedBody
     */
    private static ParsedBody parseBody(final CSVRecord record, final String prefix) {
        return new ParsedBody()
                ...
                .setAddress(new ParsedAddress()
                        ...
                        .setCountry(record.get("eh_ny_orsz"))
