...
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getAnnexADiv;
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getOwnTextFromElement;
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getSectionIIDiv;
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getSectionIIIDiv;
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getSectionIVDiv;
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getSectionVDiv;
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getSectionVIDiv;
import static eu.datlab.worker.hu.parsed.KHTenderParserUtils.getTextFromElement;
