 ...
 * @author Kuba Krafka
 */
public final class VestnikTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        ...
        final Document doc = Jsoup.parse(page.getWebResponse().getContentAsString(StandardCharsets.UTF_8));
