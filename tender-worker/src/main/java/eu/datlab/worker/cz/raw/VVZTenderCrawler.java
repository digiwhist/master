 ...
 */
public final class VVZTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        ...
        final Document doc = Jsoup.parse(page.getWebResponse().getContentAsString(StandardCharsets.UTF_8), BASE_URL);
