...
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SECTION_B_FIRST_ELEMENT_OF_FIRST_LOT_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_III_1_TITLE_SELECTOR;
...
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_II_1_9_TITLE_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_II_3_TITLE_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_IV_3_4_TITLE_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_IV_3_5_TITLE_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_I_3_TITLE_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_I_4_TITLE_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_VI_2_TITLE_SELECTOR;
import static eu.datlab.worker.nl.parsed.TenderNedTenderOldAndNewFormUtils.OLD_AND_NEW_SUBSECTION_VI_3_TITLE_SELECTOR;
