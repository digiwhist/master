 ...
 * @author Marek Mikes
 */
public final class TenderNedTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        final List<HtmlAnchor> announcementLinks = page.getByXPath("//span[@id='T909:publicatie-results']/ol/li/h3/a");
