package eu.datlab.worker.lt.raw;
 ...
 * @author Marek Mikes
 */
public final class CVPISTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        final List<HtmlAnchor> tenderDetailPageLinks = page.getByXPath(
        ...
        for (HtmlAnchor tenderDetailPageLink : tenderDetailPageLinks) {
            try {
                ...
                final List<HtmlAnchor> formLinks = tenderDetailPage.getByXPath(
                ...
                if (lotListPageLink != null) {
                    ...
                    final List<HtmlAnchor> lotLinks = lotListPage.getByXPath(
