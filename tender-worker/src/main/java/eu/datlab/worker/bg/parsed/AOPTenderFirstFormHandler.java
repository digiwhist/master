...
public final class AOPTenderFirstFormHandler {
    ...
    public static ParsedTender parse(final Document doc, final String sourceFormType, final String url) {
        ...
        parsedTender
                ...
                .addBuyer(buyer)
                .setIsJointProcurement(AOPParserUtils.parseBoolean(getValueByLabel("I_2_joint_procurement_involved", sectionI)))
                .setIsCentralProcurement(AOPParserUtils.parseBoolean(getValueByLabel("I_2_central_purchasing", sectionI)))
                ...
                .setHasLots(AOPParserUtils.parseBoolean(getValueByLabel("II_1_6_has_lots__0", sectionII)))
