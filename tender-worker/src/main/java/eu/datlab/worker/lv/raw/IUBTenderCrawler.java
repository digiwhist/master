 ...
 * @author Tomas Mrazek
 */
public final class IUBTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        final List<HtmlElement> rows = page.getByXPath("//article[@class='data_table']/section[@class='tbody']//section[@class='tr']");
