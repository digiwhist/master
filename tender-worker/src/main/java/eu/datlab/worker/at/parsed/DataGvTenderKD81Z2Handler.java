...
/**
 * Handler for form type KD_8_1_Z2.
 *
 * @author Miroslav Brezik
 */
final class DataGvTenderKD81Z2Handler extends DataGvTenderCommonHandler {

    /**
     * Default constructor suppression.
     */
    private DataGvTenderKD81Z2Handler() {
    }
    ...
    public static ParsedTender parseTender(final ParsedTender parsedTender, final Element form) {
        ...
        parseGroupDocumentUrlMan(parsedTender, form);
