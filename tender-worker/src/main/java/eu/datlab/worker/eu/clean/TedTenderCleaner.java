 ...
 * @author Tomas Mrazek
 */
public final class TedTenderCleaner extends BaseDatlabTenderCleaner {
    ...
    private static Map<Enum, List<String>> procedureTypeMapping() {
        ...
        mapping.put(TenderProcedureType.NEGOTIATED_WITH_PUBLICATION,
            Arrays.asList("pt_accelerated_negotiated", "pt_negotiated_with_competition", "PT_AWARD_CONTRACT_WITH_PRIOR_PUBLICATION",
                "PT_COMPETITIVE_NEGOTIATION", "pt_negotiated_with_prior_call", "f02_pt_accelerated_negotiated",
        ...
        mapping.put(TenderProcedureType.NEGOTIATED_WITHOUT_PUBLICATION,
            Arrays.asList("PT_NEGOTIATED_WITHOUT_PUBLICATION", "f03_award_without_prior_publication",
                "f03_pt_negotiated_without_competition", "f06_pt_negotiated_without_competition", "f06_award_without_prior_publication",
        ...
        mapping.put(TenderProcedureType.NEGOTIATED, Arrays.asList("NEGOTIATED", "pt_negotiated_choice", "PT_INVOLVING_NEGOTIATION"));
    ...
    private Map<Enum, List<String>> formTypeMapping() {
        ...
        mapping.put(PublicationFormType.CONTRACT_NOTICE, Arrays.asList("F02_2011", "F02_2014", "F05_2011", "F05_2014",
            "Contract notice", "Dynamic purchasing system", "F17_2011", "F17_2014"));
        mapping.put(PublicationFormType.CONTRACT_AWARD, Arrays.asList("F03_2011", "F03_2014", "F06_2011", "F06_2014",
            "Contract award notice", "Contract award", "VOLUNTARY_EX_ANTE_TRANSPARENCY_NOTICE", "F18_2011", "F18_2014"));
    ...
    private Map<Enum, List<String>> getSelectionMethodMapping() {
        ...
        mapping.put(null, Arrays.asList("Not specified", "Not applicable", "Not defined", "Other", "Mixed"));
