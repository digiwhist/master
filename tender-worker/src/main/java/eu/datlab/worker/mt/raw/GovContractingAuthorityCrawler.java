package eu.datlab.worker.mt.raw;
...
public final class GovContractingAuthorityCrawler extends BaseHttpCrawler {
    ...
    protected void doWork(final Message message) {
        try {
            ...
            final List<HtmlAnchor> detailLinks = page.getByXPath(
                    "//table[@id='ctl00_ctl28_g_93cfe96e_ac88_4e1e_959a_6995c309bf5e_ctl00_grdListItems']/tbody/tr/td/div/div/span/a");
