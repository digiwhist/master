...
/**
 * Contract authority parsed for Ireland.
 *
 * @author Michal Riha
 */
public class ETendersContractingAuthorityParser extends BaseContractingAuthorityParser {
    ...
    public final List<ParsedContractingAuthority> parse(final RawData rawContractingAuthority) {
        ...
        // select list sections, 0 = Name and Description, 1 = Contact informations
