 ...
 * @author Michal Riha
 */
public class GovUKTenderCleaner extends BaseDatlabTenderCleaner {
    ...
    protected final void registerSpecificPlugins() {
        ...
        pluginRegistry
            ...
            .registerPlugin("procedureType", new TenderProcedureTypePlugin(procedureTypeMapping(), Arrays.asList("Accelerated",
    ...
    private Map<Enum, List<String>> procedureTypeMapping() {
        final Map<Enum, List<String>> mapping = new HashMap<>();
        mapping.put(TenderProcedureType.OPEN, Arrays.asList("Open", "Accelerated", "OpenOJEU", "OpenNonOJEU", "OpenAcceleratedOJEU"));
        mapping.put(TenderProcedureType.RESTRICTED, Arrays.asList("Restricted", "RestrictedOJEU", "AcceleratedRestricted"));
        ...
        mapping.put(TenderProcedureType.COMPETITIVE_DIALOG, Arrays.asList("CompetitiveDialog", "CompetitiveQuotationNonOJEU",
            "CompetitiveDialogueOJEU", "CompetitiveProcedureWithNegotiationOJEU", "CompetitiveProcedureWithNegotiationAcceleratedOJEU"));
        mapping.put(TenderProcedureType.OTHER, Arrays.asList("NotApplicable", "NotSpecified"));
        mapping.put(TenderProcedureType.PUBLIC_CONTEST, Arrays.asList("CallOffFromFrameworkAgreement",
            "CallOffFromDynamicPurchasingSystem", "SingleTenderActionNonOJEU"));
        mapping.put(TenderProcedureType.INOVATION_PARTNERSHIP, Arrays.asList("InnovationPartnershipOJEU"));
