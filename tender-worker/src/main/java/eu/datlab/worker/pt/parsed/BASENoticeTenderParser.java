 ...
 * @author Tomas Mrazek
 */
public final class BASENoticeTenderParser extends BaseDatlabTenderParser {
    ...
    public List<ParsedTender> parse(final RawData raw) {
        ...
        String procedureType = BASETenderParserUtils.getFirstValueByLabel(table, "Modelo de anúncio");
