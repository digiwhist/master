 ...
 * @author Marek Mikes
 */
public final class SimapTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        final List<HtmlTableRow> noticeTableRows = page.getByXPath("//table[@id='resultList']/tbody/tr");
