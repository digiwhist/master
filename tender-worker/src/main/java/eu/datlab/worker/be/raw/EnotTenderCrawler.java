package eu.datlab.worker.be.raw;
 ...
 * @author Tomas Mrazek
 */
public final class EnotTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        final List<HtmlAnchor> nodes = page.getByXPath("//table[@id='notice']/tbody/tr/td[1]/a");
