 ...
 * @author Tomas Mrazek
 */
public final class UZPTenderCleaner extends BaseDatlabTenderCleaner {
    ...
    private Map<Enum, List<String>> formTypeMapping() {
        ...
        mapping.put(PublicationFormType.CONTRACT_NOTICE, Arrays.asList("ZP-400", "ZP-401", "ZP-402", "ZP-404",
            "ZP-407", "ZP-409", "0", "1", "2", "4", "7", "9", "(zał. 1) Ogłoszenie o zamówieniu", "(zał. 5) Ogłoszenie o konkursie",
            "(zał. :sunglasses: Ogłoszenie o zmianie umowy koncesji", "ogłoszenie o zmianie umowy", "ogłoszenie o zamówieniu",
            "ogłoszenie o konkursie"));
        mapping.put(PublicationFormType.CONTRACT_AWARD, Arrays.asList("ZP-403", "ZP-405", "ZP-408", "3", "5", "8", "(zał. 3) Ogłoszenie o" +
            " zamiarze zawarcia umowy", "(zał. 4) Ogłoszenie o udzieleniu zamówienia", "(zał. 6) Ogłoszenie o wynikach konkursu",
            "ogłoszenie o udzieleniu zamówienia", "Ogłoszenia o zamiarze zawarcia umowy"));
        mapping.put(PublicationFormType.CONTRACT_UPDATE, Arrays.asList("ZP-406", "ZP-SPR", "6", "(zał. 7) Ogłoszenie o zmianie" +
            " ogłoszenia"));
