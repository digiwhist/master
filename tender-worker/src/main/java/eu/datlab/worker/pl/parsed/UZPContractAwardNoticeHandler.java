...
public final class UZPContractAwardNoticeHandler {
    ...
    private static ParsedFunding parseFunding(final Document document) {
        return new ParsedFunding()
            .setIsEuFund(Optional.ofNullable(UZPTenderParserUtils.isEnabled("zamowienie_ue, czy_finansowane_z_unii", document))
                .map(String::valueOf).orElse(null))
            .setProgramme(JsoupUtils.selectText("projekt, nazwa_projektu_programu", document));
    }
