package eu.datlab.worker.no.raw;
 ...
 * @author Marek Mikes
 */
public final class DOFFINTenderCrawler extends BaseDatlabIncrementalPagedSourceHttpCrawler {
    ...
    public HtmlPage extractDetailsFromPage(final HtmlPage page) {
        final List<HtmlAnchor> noticeLinks = page.getByXPath("//div[@class='notice-search-item-header']/a[not(child::*)]");
