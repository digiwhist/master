package eu.datlab.worker.no.matched;

import eu.datlab.worker.matched.BaseDatlabTenderMatcher;
import eu.datlab.worker.matched.TenderDocumentsUrlMatchingPlugin;
 ...
 * @author Marek Mikes
 */
public class DOFFINTenderMatcher extends BaseDatlabTenderMatcher {
