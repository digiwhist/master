...
/**
 * Abstract matched tender lot DTO containing properties that may also be
 * directly within the tender level.
 *
 * @param <T>
 *            extending class (for fluent interface purposes)
 */
public abstract class BaseMatchedTenderLot<T> extends BaseMatchedStorableDTO implements MasterablePart {
    /**
     * Tender/Lot title.
     */
     ...
     */
    private Integer maxFrameworkAgreementParticipants;
     ...
     */
    private LocalDate awardDecisionDate;
     ...
     */
    private List<AwardCriterion> awardCriteria;
     ...
     */
    private Integer envisagedCandidatesCount;

    /**
     * Min number of envisaged candidates.
     */
    private Integer envisagedMinCandidatesCount;

    /**
     * Max number of envisaged candidates.
     */
    private Integer envisagedMaxCandidatesCount;
