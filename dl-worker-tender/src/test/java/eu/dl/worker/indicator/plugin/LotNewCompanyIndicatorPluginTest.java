 ...
 * @author Jakub Krafka
 */
public final class LotNewCompanyIndicatorPluginTest {
    ...
    private final LotNewCompanyIndicatorPlugin plugin = new LotNewCompanyIndicatorPlugin();
    ...
    public void undefinedIndicatorTest() {
        assertEquals(plugin.evaluate(nullTender.getLots().get(0), nullTender).getStatus(), IndicatorStatus.UNDEFINED);
        assertEquals(plugin.evaluate(tender1.getLots().get(0), tender1).getStatus(), IndicatorStatus.UNDEFINED);
        assertEquals(plugin.evaluate(tender2.getLots().get(0), tender2).getStatus(), IndicatorStatus.UNDEFINED);
        assertEquals(plugin.evaluate(tender3.getLots().get(0), tender3).getStatus(), IndicatorStatus.UNDEFINED);
        assertEquals(plugin.evaluate(tender4.getLots().get(0), tender4).getStatus(), IndicatorStatus.UNDEFINED);
        assertEquals(plugin.evaluate(tender8.getLots().get(0), tender8).getStatus(), IndicatorStatus.UNDEFINED);
        assertEquals(plugin.evaluate(tender9.getLots().get(0), tender9).getStatus(), IndicatorStatus.UNDEFINED);
    }
    ...
    public void insufficientIndicatorTest() {
        assertEquals(plugin.evaluate(null, null).getStatus(), IndicatorStatus.INSUFFICIENT_DATA);
        assertEquals(plugin.evaluate(new MasterTenderLot(), null).getStatus(), IndicatorStatus.INSUFFICIENT_DATA);
        assertEquals(plugin.evaluate(null, new MasterTender()).getStatus(), IndicatorStatus.INSUFFICIENT_DATA);
    }
